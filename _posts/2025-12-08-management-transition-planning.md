...
The 100-day plan before and after acquisition close:

## Pre-Close Transition Planning (Days -60 to 0)

**Information Gathering**
- Document all standard operating procedures (or lack thereof)
...
- 1-on-1s with every employee (what's working, what's not, what would they change)
- Shadow different roles (sales calls, ops floor, customer service)
- Understand current metrics and reporting (even if imperfect)
- Quick wins: fix obvious broken processes, clean up workspace, invest in morale

**Key Questions to Answer**
- Where does the money actually come from? (not what CRM says, but reality)
- What would cause customers to leave?
- What would cause key employees to leave?
...
**Priorities**
- Confirm or adjust comp structure for key employees
- Install basic financial reporting if missing (weekly cash, monthly P&L)
- Identify and prioritize top 3-5 operational improvements
- Build trust with customers (calls, visits, reassurance)
